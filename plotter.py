...
# File Paths
TRAJECTORY_FILE = "TGSIM_Moving.csv"
...
def plot_trajectories():
    ...
    try:
        ...
        centerline_file = os.path.join(CENTERLINE_FOLDER, f"I-90-moving-Run_{run_index}-geometry-with-ramps.csv")
        ...
        fig.write_html("Moving_Full_Plot.html")
